        ...
        <div className="dashboard-shell">
            <div className="dashboard-wrap">
                ...
                <section className="dashboard-grid">
                    ...
                    <article className="dashboard-card"><h2>Plan & Entitlements</h2><div className="dashboard-list"><div className="dashboard-row"><span>Offer</span><strong>{entitlement.commercialOffer}</strong></div><div className="dashboard-row"><span>Room Limit</span><strong>{entitlement.roomLimit ?? 'Unlimited'}</strong></div><div className="dashboard-row"><span>Pet History Limit</span><strong>{entitlement.petHistoryLimit ?? 'Unlimited'}</strong></div>{entitlement.supportTier && <div className="dashboard-row"><span>Support</span><strong>{entitlement.supportTier}</strong></div>}</div></article>
                </section>
